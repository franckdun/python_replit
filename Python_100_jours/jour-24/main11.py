...
def roll_dice():
    ...
    """
    return sorted([random.randint(1, 6) for _ in range(3)], reverse=True)# creer une liste de 3 nombres aleatoire entre 1 et 6 et les trier de plus grand a plus petit
...
def display_dice_and_score(dice):
    ...
    print("\nRésultats des dés auto_rangés :", convertice(dice))
    score = sum(dice)
...
def play_421():
    ...
    while True:
        ...
        if current_score == 421 or convertice(dice) == 421:
        ...
        #print("Faire 'q' pour sortir du jeu.")

        reroll_choice = input("Quel quel dé relancer ? ")
