...
def roll_dice():
    ...
    """
    # Générer trois nombres aléatoires entre 1 et 6 et les stocker dans une liste [] et "reverse" range les dés du plus grand au plus petit.
...
def play_421_with_points_and_rerolls():
    ...
    while True:
        ...
        print("Nombre de tours joués :", num_turns)
        if points == 421:
            break
        else:
