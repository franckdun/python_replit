...
# Listes de bruits.
sounds = [
    "Ouaf Ouaf", "Miaou", "Cocorico", "Meuh", "Rouah", "Houhou", "Croa Croa",
    "Bzz Bzz", "Cri-cri", "Hi Hi Hi"
]
# Liste de animaux.
animals = [
    "chien", "chat", "coq", "vache", "lion", "hibou", "grenouille", "abeille",
    "criquet", "cheval"
]
# Liste de types de cris.
termbrui = [
    "aboiement", "miaulement", "chant", "meuglement", "rugissement",
    "hululement", "coassement", "bourdonnement", "stridule", "hennissement"
]
...
while counter < 3:
    ...
    devinette = input("Tentative {}: Quel animal fait le bruit {} ? ".format(
        counter + 1, sound_choisi))
    ...
    if devinette.lower() == animal_attendu:
        print("Bravo ! Tu as deviné le {} de {}.\n".format(
            termbrui_attendu, animal_attendu))
...
print(
    "Fin du jeu. Ton score final est de {} bonnes réponses sur {} questions.".
    format(score, question))
